...
//
// Local override of al_folio_core's assets/js/theme.js (gem version 1.0.15).
// Only change from upstream: when there is no stored preference yet (first visit,
// or localStorage cleared), fall back to "light" instead of "system" -- upstream's
// "system" default meant a visitor whose OS/browser is in dark mode would see this
// site in dark mode on first load. The theme toggle (light/dark/system) still works
// exactly as before once a visitor clicks it.
